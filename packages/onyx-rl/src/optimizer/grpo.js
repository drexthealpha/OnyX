 ...
 */
export function optimize(trajectories, rewards) {
    ...
    const allRelativeRewards = [];
    const affectedSkillSet = new Set();
    ...
    const gradientSignal = allRelativeRewards.length > 0
