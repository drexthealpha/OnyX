"""ONYX RL Data Preprocessor.

Ported from Gen-Verse/OpenClaw-RL toolcall-rl/rl_data_preprocess.py.
Preprocesses DAPO-Math-17k dataset for ONYX RL training.
"""
...
# save to jsonl
ds2.to_json(
    "/root/dapo-math-17k-processed/dapo_math_17k_cleaned.jsonl",
    orient="records",
    lines=True,
)