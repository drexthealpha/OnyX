...
import { loadUnprocessedTrajectories, markTrajectoryProcessed, savePolicyUpdate, countUnprocessedTrajectories, } from "./db.js";
 ...
 */
export function maybeRunPipeline() {
    if (_pipelineRunning)
        return;
...
export async function runPipeline() {
    ...
    try {
        ...
        console.log(`[onyx-rl] Pipeline complete: processed=${trajectories.length} ` +
