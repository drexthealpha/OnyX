import { Plugin, Provider, IAgentRuntime, Memory, State, ModelType, ProviderResult } from "@elizaos/core";
...
export const recentIntelProvider: Provider = {
  ...
  get: async (runtime: IAgentRuntime, message: Memory, state: State): Promise<ProviderResult> => {
    ...
    try {
      ...
      return { text: "Recent intel: " + result, values: { topic: topic as string, intel: result as string } };
    } catch {
      return { text: "", values: {} };
    }
  }
