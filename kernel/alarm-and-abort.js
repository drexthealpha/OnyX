 ...
 */
export function register(operationId, handler) {
 ...
 */
export async function abort(operationId, code) {
    const handler = _registry.get(operationId);
    if (!handler) {
        throw new Error(`[alarm-and-abort] Cannot abort unknown operation "${operationId}". ` +
 ...
 */
export function clear(operationId) {
    _registry.delete(operationId);
}
//# sourceMappingURL=alarm-and-abort.js.map